...
{
    public class PlayerEntryList : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            else
            {
                ...
                PlayerReadyButton.onClick.AddListener(() =>
                {
                    ...
                    {
                        FindObjectOfType<PhotonLobby>().LocalPlayerPropertiesUpdated();
                    }
                });
            }
        }
        ...
        private void OnPlayerNumberingChanged()
        {
            foreach (Player p in PhotonNetwork.PlayerList)
            {
                ...
                {
                    PlayerColorImage.color = GameManager.GetColor(p.GetPlayerNumber());
                }
            }
        }
